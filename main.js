function isOperator(value){
    ...
    //This function checks whether the value given as an argument is an operator 
    //or not. If it is an operator then it returns true, if not it returns false
    //This is a simple way to return boolean values from conditions without using 
...
function updateScreen(displayValue){
    ...
    //The substring inbuilt function extracts charcaters in between the given
